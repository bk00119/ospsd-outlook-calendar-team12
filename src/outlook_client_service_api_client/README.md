# outlook-client-service-api-client
A client library for accessing Outlook Client Service

## Usage
First, create a client:

```python
from outlook_client_service_api_client import Client
...
```python
from outlook_client_service_api_client import AuthenticatedClient
...
```python
from outlook_client_service_api_client.models import MyDataModel
from outlook_client_service_api_client.api.my_tag import get_my_data_model
from outlook_client_service_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `outlook_client_service_api_client.api.default`
