...
- **Integration Tests**: Full API tests with Outlook credentials (protected branches only)
...
Create a **Context** named `outlook-client` with:
...
**Missing environment variables**: Ensure `outlook-client` context is created and applied to integration jobs
